...
#You define a function that captures the webcam feed, detects faces, and authenticates based on trained facial data.
def AuthenticateFace():
    ...
    names = ['', 'Avika']  # names, leave first empty bcz counter starts from 0


    cam = cv2.VideoCapture(0, cv2.CAP_DSHOW)  # cv2.CAP_DSHOW to remove warning (webcam) open krta hai
